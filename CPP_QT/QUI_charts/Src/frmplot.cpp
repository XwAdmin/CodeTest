...
void frmPlot::ChangeVisible()
{
    ...
    ui->customPlot5->setVisible(false);
    ui->customPlot6->setVisible(false);
    ui->customPlot7->setVisible(false);
    ui->customPlot8->setVisible(false);
    ui->customPlot9->setVisible(false);
    ui->customPlot10->setVisible(false);
    ui->customPlot11->setVisible(false);
    ui->customPlot12->setVisible(false);
    ui->customPlot13->setVisible(false);
    ui->customPlot14->setVisible(false);
    ui->customPlot15->setVisible(false);
    ui->customPlot16->setVisible(false);
}

void frmPlot::setupDemo(int demoIndex)
{
    switch (demoIndex) {
    case 0:
        ChangeVisible();
        setupQuadraticDemo(ui->customPlot1);
        ui->customPlot1->setVisible(true);
        break;
    case 1:
        ChangeVisible();
        setupSimpleDemo(ui->customPlot2);
        ui->customPlot2->setVisible(true);
        break;
    case 2:
        ChangeVisible();
        setupSincScatterDemo(ui->customPlot3);
        ui->customPlot3->setVisible(true);
        break;
    case 3:
        ChangeVisible();
        setupScatterStyleDemo(ui->customPlot4);
        ui->customPlot4->setVisible(true);
        break;
    case 4:
        ChangeVisible();
        setupScatterPixmapDemo(ui->customPlot5);
        ui->customPlot5->setVisible(true);
        break;
    case 5:
        ChangeVisible();
        setupLineStyleDemo(ui->customPlot6);
        ui->customPlot6->setVisible(true);
        break;
    case 6:
        ChangeVisible();
        setupDateDemo(ui->customPlot7);
        ui->customPlot7->setVisible(true);
        break;
    case 7:
        ChangeVisible();
        setupTextureBrushDemo(ui->customPlot8);
        ui->customPlot8->setVisible(true);
        break;
    case 8:
        ChangeVisible();
        setupMultiAxisDemo(ui->customPlot9);
        ui->customPlot9->setVisible(true);
        break;
    case 9:
        ChangeVisible();
        setupLogarithmicDemo(ui->customPlot10);
        ui->customPlot10->setVisible(true);
        break;
    case 10:
        ChangeVisible();
        setupRealtimeDataDemo(ui->customPlot11);
        ui->customPlot11->setVisible(true);
        break;
    case 11:
        ChangeVisible();
        setupParametricCurveDemo(ui->customPlot12);
        ui->customPlot12->setVisible(true);
        break;
    case 12:
        ChangeVisible();
        setupBarChartDemo(ui->customPlot13);
        ui->customPlot13->setVisible(true);
        break;
    case 13:
        ChangeVisible();
        setupStatisticalDemo(ui->customPlot14);
        ui->customPlot14->setVisible(true);
        break;
    case 14:
        ChangeVisible();
        setupSimpleItemDemo(ui->customPlot15);
        ui->customPlot15->setVisible(true);
        break;
    case 15:
        ChangeVisible();
        setupItemDemo(ui->customPlot16);
        ui->customPlot16->setVisible(true);
        break;
    }
...
void frmPlot::setupQuadraticDemo(QCustomPlot *customPlot)
{
    // generate some data:
...
void frmPlot::setupSimpleDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupSincScatterDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupScatterStyleDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupLineStyleDemo(QCustomPlot *customPlot)
{
    customPlot->legend->setVisible(true);
    customPlot->legend->setFont(QFont("Helvetica", 9));
...
void frmPlot::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupDateDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupTextureBrushDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupMultiAxisDemo(QCustomPlot *customPlot)
{
    customPlot->setRangeDrag(Qt::Horizontal | Qt::Vertical);
    customPlot->setRangeZoom(Qt::Horizontal | Qt::Vertical);
...
void frmPlot::setupLogarithmicDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupRealtimeDataDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupParametricCurveDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupBarChartDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupStatisticalDemo(QCustomPlot *customPlot)
{
...
void frmPlot::setupSimpleItemDemo(QCustomPlot *customPlot)
{
    customPlot->setRangeDrag(Qt::Horizontal | Qt::Vertical);
    customPlot->setRangeZoom(Qt::Horizontal | Qt::Vertical);
...
void frmPlot::setupItemDemo(QCustomPlot *customPlot)
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
...
void frmPlot::realtimeDataSlot()
{
  ...
  if (key-lastPointKey > 0.01) // at most add point every 10 ms
  {
    ...
    // add data to lines:
    ui->customPlot11->graph(0)->addData(key, value0);
    ui->customPlot11->graph(1)->addData(key, value1);
    // set data of dots:
    ui->customPlot11->graph(2)->clearData();
    ui->customPlot11->graph(2)->addData(key, value0);
    ui->customPlot11->graph(3)->clearData();
    ui->customPlot11->graph(3)->addData(key, value1);
    // remove data of lines that's outside visible range:
    ui->customPlot11->graph(0)->removeDataBefore(key-8);
    ui->customPlot11->graph(1)->removeDataBefore(key-8);
    // rescale value (vertical) axis to fit the current data:
    ui->customPlot11->graph(0)->rescaleValueAxis();
    ui->customPlot11->graph(1)->rescaleValueAxis(true);
    lastPointKey = key;
  }
  // make key axis range scroll with the data (at a constant range size of 8):
  ui->customPlot11->xAxis->setRange(key+0.25, 8, Qt::AlignRight);
  ...
  if (key-lastFpsKey > 2) // average fps over 2 seconds
  {
    qDebug()<<QString("%1 FPS, Total Data points: %2")
              ...
              .arg(ui->customPlot11->graph(0)->data()->count()+ui->customPlot11->graph(1)->data()->count());
    lastFpsKey = key;
    frameCount = 0;
  }
}

void frmPlot::bracketDataSlot()
{
#if QT_VERSION < QT_VERSION_CHECK(4, 7, 0)
  double secs = 0;
#else
  ...
  ui->customPlot16->graph()->setData(x, y);

  itemDemoPhaseTracer->setGraphKey((8*M_PI+fmod(M_PI*1.5-phase, 6*M_PI))/k);

  ui->customPlot16->replot();
  ...
  if (key-lastFpsKey > 2) // average fps over 2 seconds
  {
    qDebug()<<QString("%1 FPS, Total Data points: %2")
              .arg(frameCount/(key-lastFpsKey), 0, 'f', 0)
              .arg(ui->customPlot16->graph(0)->data()->count());
    lastFpsKey = key;
    frameCount = 0;
  }
}

void frmPlot::on_btn1_clicked()
{
    this->setupDemo(0);
}

void frmPlot::on_btn2_clicked()
{
    this->setupDemo(1);
}

void frmPlot::on_btn3_clicked()
{
    this->setupDemo(2);
}

void frmPlot::on_btn4_clicked()
{
    this->setupDemo(3);
}

void frmPlot::on_btn5_clicked()
{
    this->setupDemo(4);
}

void frmPlot::on_btn6_clicked()
{
    this->setupDemo(5);
}

void frmPlot::on_btn7_clicked()
{
    this->setupDemo(6);
}

void frmPlot::on_btn8_clicked()
{
    this->setupDemo(7);
}

void frmPlot::on_btn9_clicked()
{
    this->setupDemo(8);
}

void frmPlot::on_btn10_clicked()
{
    this->setupDemo(9);
}

void frmPlot::on_btn11_clicked()
{
    this->setupDemo(10);
}

void frmPlot::on_btn12_clicked()
{
    this->setupDemo(11);
}

void frmPlot::on_btn13_clicked()
{
    this->setupDemo(12);
}

void frmPlot::on_btn14_clicked()
{
    this->setupDemo(13);
}

void frmPlot::on_btn15_clicked()
{
    this->setupDemo(14);
}

void frmPlot::on_btn16_clicked()
{
    this->setupDemo(15);
}
